...
topics = [
    ("Tähtimalli",         "star schema",        True),
    ("Dimensiot",          "dimensions",         True),
    ("Faktataulut",        "fact tables",        False),
    ("Litistäminen",       "flattening",         False),
    ("AI-valmis metadata", "AI-ready metadata",  False),
]
...
for i, (fi, en, hi) in enumerate(topics):
...
try:
    logo_src = Image.open("/home/samu/data mallit/sivusto/kuvat/dataneuvos_logo.png").convert("RGBA")
...
draw.text((60, 140), "Datamalli.fi", font=f_title, fill=WHITE)

sub_color = (185, 220, 198)
draw.text((60, 252), "Datan mallinnuksen opas —", font=f_sub, fill=sub_color)
draw.text((60, 290), "tähtimalli, dimensiot ja faktataulut.", font=f_sub, fill=sub_color)

tags = ["tähtimalli", "Power BI", "data vault"]
...
out = "/home/samu/data mallit/sivusto/kuvat/og-datamalli.png"
