...
'data-governance.html': `data governance organisaation datan hallinnan pelisäännöt päätökset vastuut prosessit standardit
organisatorinen muutos kulttuuri työkaluhankinta
kuka omistaa datan kuka saa käyttää laatu varmistetaan elinkaari hallitaan
kukaan ei tiedä mistä data tulee kuka vastaa onko luotettavaa
...
kaiken datan omistaja pullonkaula tietoalueittain hr-data talousdata cfo
datan laatu ulottuvuudet täydellisyys tarkkuus ajantasaisuus johdonmukaisuus ainutlaatuisuus
laadunvalvonta tietovirta etl elt hälytykset data quality sivu laatumittarit
metadata dataa datasta tekninen metadata liiketoimintametadata tietotyypit päivitysaikaleima
datakatalogi datakirjasto liiketoimintakuvaukset aktiivinen asiakas
gdpr yleinen tietosuoja-asetus henkilötiedot tietojen kartoitus käyttötarkoituksen rajaus
käyttöoikeuksien hallinta säilytysajat anonymisointi rekisteröidyn oikeudet
rivitason tietoturva row-level security rls raportit henkilötietoja
datan elinkaari kerääminen käsittely jalostus tallennus jakelu käyttö arkistointi hävittäminen
säilytysaikapolitiikka kylmä arkisto turvallinen poisto tietosuojariski
data governance -ohjelma nykytilan arviointi kriittiset tietoalueet omistajien nimeäminen
säännöt standardit nimeämiskäytännöt laatukriteerit työkalujen valinta koulutus viestintä
jatkuva kehittäminen asiakkaat tuotteet myynti johdon tuki muutosvastarinta`,
